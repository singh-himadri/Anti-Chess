...
// Function to check for a win and display a popup
...
// Function to quit the game and display a popup
function quitGame(color) {
  if (color === 'WHITE') {
      showPopup("Black wins by resignation!");
  } else if (color === 'BLACK') {
      showPopup("White wins by resignation!");
  }
}

document.getElementById('quitWhite').addEventListener('click', () => quitGame('WHITE'));
document.getElementById('quitBlack').addEventListener('click', () => quitGame('BLACK'));
